...
本项目的部分产品思路与工作流设计参考了 [CineGen-AI](https://github.com/Will-Water/CineGen-AI) 在提交 `6505c9076f8d72df837e5062b8df1d90319a4e83` 时公开展示的内容。

此处说明仅用于标注灵感参考来源，不表示当前项目与其后续版本存在持续性的代码同步或商业授权关系。
